...
# Zoom in to study area
Map$setCenter(27.8, 51, 7) # Third value is zoom
# Plot fires
Map$addLayer(pixels)
...
pop <- ee$ImageCollection("CIESIN/GPWv411/GPW_Population_Density")$select('population_density')
